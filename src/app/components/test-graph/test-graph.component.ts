...
export class TestGraphComponent implements OnInit {
  ...
  ngOnInit(): void {
    var nodes = new DataSet([
      ...
      { id: '04', label: 'ด้านบริหารจัดการ', fixed: true, x: 400, y: 240, shape: 'box', group: 'bottomNodes' },
      { id: '04-01', label: 'กลยุทธ์', fixed: true, x: 600, y: 190, shape: 'box', group: 'bottomNodes' },
