...
export class TestGraphComponent implements OnInit {
  ...
  ngOnInit(): void {
    var nodes = new DataSet([
      ...
      { id: '01-03', label: 'ลูกค้าในปัจจุบัน', fixed: true, x: 10, y: 1, group: 'secondaryNodes2' },
      { id: '01-04', label: 'ลูกค้าในอนาคต', fixed: true, x: 150, y: -1, group: 'secondaryNodes' },
      { id: '01-04-01', label: 'การรับนักศึกษา', fixed: true, x: 150, y: -86, group: 'secondaryNodes1' },
      { id: '01-05', label: 'การพัฒนาอาจารย์', fixed: true, x: 300, y: -1, group: 'secondaryNodes' },
      { id: '01-05-01', label: 'WiL', fixed: true, x: 270, y: -85, group: 'secondaryNodes' },
      { id: '01-05-02', label: 'PBL', fixed: true, x: 400, y: -80, group: 'secondaryNodes' },
      { id: '01-05-03', label: 'Up/ReSkill', fixed: true, x: 350, y: -184, group: 'secondaryNodes1' },
      { id: '01-06', label: 'MC+บัณฑิตพันธุ์ใหม่', fixed: true, x: 450, y: 27, group: 'secondaryNodes' },
